...
import { CreateLiveStreamParams, CreatePlaybackIdParams, ListLiveStreamParams, LiveStream, PlaybackId, SimulcastTarget, SimulcastTargetParams, UpdateLiveStreamEmbeddedSubtitlesParams, UpdateLiveStreamGeneratedSubtitlesParams, UpdateLiveStreamParams } from '../domain.js';
/**
...
export declare class LiveStreams extends Base {
     ...
     * @returns {Promise} - Returns a resolved Promise with a response from the Mux API
     */
    updateEmbeddedSubtitles(liveStreamId: string, params: UpdateLiveStreamEmbeddedSubtitlesParams): Promise<LiveStream>;
    /**
     ...
     * @returns {Promise} - Returns a resolved Promise with a response from the Mux API
     */
    updateGeneratedSubtitles(liveStreamId: string, params: UpdateLiveStreamGeneratedSubtitlesParams): Promise<LiveStream>;
    /**
