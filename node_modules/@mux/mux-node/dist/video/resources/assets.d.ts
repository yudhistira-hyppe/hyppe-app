...
import { Asset, CreateAssetParams, CreatePlaybackIdParams, CreateTrackParams, InputInfo, ListAssetParams, PlaybackId, Track, UpdateAssetParams, UpdateMasterAccessParams, UpdateMp4SupportParams } from '../domain.js';
/**
...
export declare class Assets extends Base {
     ...
     * @returns {Promise} - Returns a resolved Promise with a response from the Mux API
     */
    update(assetId: string, params: UpdateAssetParams): Promise<Asset>;
    /**
     * Deletes a Mux asset
