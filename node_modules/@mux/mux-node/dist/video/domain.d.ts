...
export declare type AssetMp4Support = 'none' | 'standard';
export declare type AssetMasterAccess = 'none' | 'temporary';
export declare type TrackStatus = 'preparing' | 'ready' | 'errored';
export declare type LatencyMode = 'low' | 'reduced' | 'standard';
export declare type RecordingTimesType = 'content' | 'slate';
...
export declare type Track = VideoTrack | AudioTrack | TextTrack;
...
export declare type SpaceStatus = 'idle' | 'active';
export declare type BroadcastStatus = 'idle' | 'active';
export declare type BroadcastLayout = 'gallery' | 'active-speaker';
export declare type BroadcastResolution = '1920x1080' | '1280x720' | '1080x1920' | '720x1280' | '1080x1080' | '720x720';
