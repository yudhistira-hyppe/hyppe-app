...
class _BetterPlayerWithControlsState extends State<BetterPlayerWithControls> {
  ...
  Widget build(BuildContext context) {
    ...
    //   }
    // } else {
    //   print('aspectRatio betterplayer: ${betterPlayerController.getAspectRatio()}');
  ...
  Container _buildPlayerWithControls(BetterPlayerController betterPlayerController, BuildContext context) {
    ...
    bool overlayShown = betterPlayerController.betterPlayerConfiguration.overlayShownWhenFullScreen;
    if(overlayShown){
      overlayShown = betterPlayerController.isFullScreen;
    }
    return Container(
      child: Stack(
        ...
        children: <Widget>[
          ...
          overlayShown ? (betterPlayerController.getOverlay() ?? Container()) : Container(),
...
class _BetterPlayerVideoFitWidgetState extends State<_BetterPlayerVideoFitWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    final fixVideoSize = widget.betterPlayerController.betterPlayerConfiguration.videoSize;
    final fixWidth = fixVideoSize?.width ?? controller?.value.size?.width;
    final fixHeight = fixVideoSize?.height ?? controller?.value.size?.height;
