...
class _BetterPlayerMaterialControlsState extends BetterPlayerControlsState<BetterPlayerMaterialControls> {
    ...
    return GestureDetector(
      ...
      child: AbsorbPointer(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            if (_wasLoading) Center(child: _buildLoadingWidget()) else if (_betterPlayerController?.betterPlayerControlsConfiguration.skipAdsButtonAt == null) _buildHitArea(),
            Positioned(
              top: 0,
              left: 0,
              right: 0,
            ...
            if (_betterPlayerController?.betterPlayerControlsConfiguration.skipAdsButtonAt != null) _buildSkipAdsVideoWidget() else _buildNextVideoWidget(),
          ],
        ),
      ),
    );
  ...
  Widget _buildPosition() {
    ...
    if (_betterPlayerController?.betterPlayerControlsConfiguration.skipAdsButtonAt != null) {
      if (inSecond < _latestValue!.position.inSeconds) {
        inSecond++;
        skipAdsPosition = skipAdsPosition! - 1;
      }
    }
  ...
  void startTimer() {
    ...
    timerSkipAds = new Timer.periodic(
      oneSec,
      (Timer timer) {
        if (skipAdsPosition == 0) {
          timer.cancel();
        } else {
          skipAdsPosition = skipAdsPosition! - 1;
        }
  ...
  Widget _buildSkipAdsVideoWidget() {
    return ValueListenableBuilder<bool>(
      valueListenable: _betterPlayerController!.skipAdsEventValueNotifier,
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    width: !value ? 100 : null,
                    child: Text(
                      !value ? " Your video will begin in ${skipAdsPosition}" : " ${_betterPlayerController!.translations.skipAds}",
                      maxLines: 3,
                  ...
                  value
                      ...
                      : Container(),
                  Container(child: Image.network(_betterPlayerController!.betterPlayerControlsConfiguration.imagesAdsVid!))
                ],
              ),
            ),
          ),
  ...
  Future<void> _initialize() async {
    skipAdsPosition = _betterPlayerController?.betterPlayerControlsConfiguration.skipAdsButtonAt;
