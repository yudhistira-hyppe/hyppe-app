...
class BetterPlayerTranslations {
  ...
  final String skipAds;
  final String reportThisContent;
  ...
  BetterPlayerTranslations(
      {this.languageCode = "en",
        ...
        this.skipAds = "Skip Ads",
        this.reportThisContent = "Report this Ads",});
