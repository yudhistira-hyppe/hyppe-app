...
class SearchScreenLama extends StatefulWidget {
  @override
  _SearchScreenLamaState createState() => _SearchScreenLamaState();
}

class _SearchScreenLamaState extends State<SearchScreenLama> with SingleTickerProviderStateMixin {
                ...
                child: Column(
                  children: [
                    ...
                    TabBar(
                      ...
                      tabs: const [
                        OptionBar(title: "Vid", icon: "", pageIndex: 0),
