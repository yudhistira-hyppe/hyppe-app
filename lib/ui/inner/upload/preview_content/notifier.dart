...
class PreviewContentNotifier with ChangeNotifier {
  ...
  Future<void> videoMerger(BuildContext context, String urlAudio,
      {isInit = false}) async {
    try {
  ...
  Future restartVideoPlayer(String outputPath, BuildContext context,
  ...
  void navigateToPreUploaded(BuildContext context,
    ...
    Routing()
        .move(Routes.preUploadContent,
            argument: UpdateContentsArgument(onEdit: false))
        .whenComplete(() => isForcePaused = false);
  }
