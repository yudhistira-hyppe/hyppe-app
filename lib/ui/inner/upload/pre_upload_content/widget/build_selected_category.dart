...
class BuildSelectedCategory extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final notifier = Provider.of<PreUploadContentNotifier>(context);
    return ListTile(
      title: Text(notifier.selectedLocation, maxLines: 1, style: TextStyle(fontFamily: "Roboto", fontWeight: FontWeight.w400, color: const Color(0xff822E6E), fontSize: 14 * SizeConfig.scaleDiagonal)),
