...
class _PreUploadContentScreenState extends State<PreUploadContentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Consumer<PreUploadContentNotifier>(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: FlutterMentions(
                              ...
                              key: key,
                              defaultText: notifier.captionController.text,
                              ...
                              decoration: InputDecoration(
                                ...
                                hintStyle: textTheme.bodySmall?.copyWith(color: kHyppeSecondary),
                                border: InputBorder.none,
                                counterText: "",
                              ),
                              onChanged: (val) {
                                notifier.captionController.text = key.currentState!.controller!.markupText;
                              },
                              onSearchChanged: (val, value) {
                                print(val);
                                print(value);
                                if (val == '@') {
                                  notifier.searchPeople(context, input: value);
                                }
                              },
                              mentions: [
                                Mention(
                                    trigger: '@',
                                    style: TextStyle(
                                      color: Color.fromARGB(255, 165, 7, 159),
                                    ),
                                    data:
                                        // (map['categories'] as List)?.map((item) => item as String)?.toList();

                                        // notifier.searchPeolpleData ,
                                        [
                                      {
                                        'id': '61as61fsa',
                                        'display': 'fayeedP',
                      ...
                      Row(
                        children: [
                          CustomElevatedButton(
                              ...
                              height: 30,
                              function: () {
                                final text = key.currentState!.controller!.text;
                                final selection = key.currentState!.controller!.selection;

                                final newText = text.replaceRange(selection.start, selection.end, ' #');
                                key.currentState!.controller!.value = TextEditingValue(
                                  text: newText,
                      ...
                      _buildDivider(context),
                      Text("${notifier.userTagData.length}"),
                      Text("${notifier.locationName}"),
                      twentyFourPx,
                      fourPx,
