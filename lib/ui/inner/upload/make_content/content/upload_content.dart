            ...
            additionalViews: <Widget>[
              ...
              if(notifier.showToast)
                Align(
                  ...
                  child: CustomTextWidget(textToDisplay: notifier.featureType == FeatureType.story ? (notifier.language.recordAtLeast4Seconds ?? 'Error') : (notifier.language.recordAtLeast15Seconds ?? 'Error'), textStyle: const TextStyle(color: Colors.white),),
                ),
                      ],
                    )),
              // Timer
