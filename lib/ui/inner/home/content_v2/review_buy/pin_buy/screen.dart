...
class PinBuyScreen extends StatelessWidget {
  final dynamic mounted;
  const PinBuyScreen({Key? key, required this.mounted}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    FirebaseCrashlytics.instance.setCustomKey('layout', 'PinBuyScreen');
    // var setPin = SharedPreference().readStorage(SpKeys.setPin);
    return Consumer2<ReviewBuyNotifier, TranslateNotifierV2>(
          ...
          child: Column(
            children: [
              ...
              PinWithdrawal(
                ...
                onChanged: (val) {},
                onCompleted: (value) {
                  notifier.buyContent(context, mounted);
                },
              ),
            ],
          ),
