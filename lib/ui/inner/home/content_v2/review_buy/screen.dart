                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          contentInfo(textTheme, title: 'Service Fee (${notifier.data!.prosentaseAdminFee})', value: System().currencyFormat(amount: notifier.data!.serviceFee!.toInt())),
                          contentInfo(textTheme, title: "Admin Fee", value: System().currencyFormat(amount: notifier.data!.adminFee!.toInt())),
                        ],
                      ),
                    ),
                  ],
