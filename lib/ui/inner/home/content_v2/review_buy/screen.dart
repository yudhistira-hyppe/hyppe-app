...
class _ReviewBuyContentScreenState extends State<ReviewBuyContentScreen> {
  ...
  late ReviewBuyNotifier notifier;
  ...
  void initState() {
    ...
    notifier = Provider.of<ReviewBuyNotifier>(context, listen: false);
  ...
  @override
  void dispose() {
    notifier.discount = DiscountModel();
    super.dispose();
  }
                          ...
                          title: (notifier.discount != null)
                              ? Column(
                                  ...
                                  children: [
                                    CustomTextWidget(
                                        textToDisplay:
                                            '${notifier.language.discount} ${System().currencyFormat(amount: notifier.discount?.nominal_discount)}'),
                                    CustomTextWidget(
                                      textToDisplay:
                                          notifier.discount?.code_package ?? '',
                              ...
                              : Text(notifier.language.discountForYou ??
                                  'Diskon Untukmu'),
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: SizedBox(
                          ...
                          child: Center(
                            child: Text(notifier.language.buy ?? 'Beli',
