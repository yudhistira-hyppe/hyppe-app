            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: widget.data?.music?.musicTitle != null ? widget.data?.mediaType == 'video' ? MusicStatusPage(music: widget.data!.music!, vertical: 0,) : notifier.isLoadMusic ? LoadingMusicStory(apsaraMusic: widget.data!.music!): MusicStatusPage(music: widget.data!.music!, urlMusic: notifier.urlMusic?.playUrl ?? '', vertical: 0,) : const SizedBox.shrink(),
                ),
                Container(
                        alignment: Alignment.center,
                        width: SizeConfig.screenWidth,
