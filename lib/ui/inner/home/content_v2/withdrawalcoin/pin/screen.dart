...
class PinWithdrawalNewScreen extends StatelessWidget {
  final bool mounted;
  const PinWithdrawalNewScreen({Key? key, required this.mounted}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    FirebaseCrashlytics.instance.setCustomKey('layout', 'PinWithdrawalCoinScreen');
    // var setPin = SharedPreference().readStorage(SpKeys.setPin);
    return Consumer2<WithdrawalCoinNotifier, TranslateNotifierV2>(
          ...
          child: Column(
            children: [
              ...
              PinWithdrawal(
                ...
                onChanged: (val) {},
                onCompleted: (value) {
                  notifier.createWithdrawal(context, mounted, notifier2);
                },
              ),
            ],
          ),
