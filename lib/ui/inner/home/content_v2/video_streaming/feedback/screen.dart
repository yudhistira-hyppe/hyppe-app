            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextWidget(
                    textToDisplay:
                        '${System().dateFormatter(DateTime.now().toString(), 3)} • ${language.duration} ${(widget.arguments?.duration.inMinutes ?? 0) < 9 ? '0' : ''}${widget.arguments?.duration.inMinutes} : ${(widget.arguments?.duration.inSeconds ?? 0) % 60}',
