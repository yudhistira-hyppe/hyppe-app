            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  tenPx,
                  Text(
                    tn.localeDatetime == 'id' ? 'Laporan diterima' : 'We`ve got your report',
                    style: const TextStyle(color: kHyppeTextLightPrimary, fontSize: 22, fontWeight: FontWeight.bold),
                    textAlign: TextAlign.center,
                  ),
                  tenPx,
                  Text(
                    tn.localeDatetime == 'id' ? 'Kami akan meninjau laporanmu dan mengambil tindakan jika ditemukan pelanggaran.' : 'Our team on it! We`ll investigate and take appropriate measures.',
                    style: TextStyle(
                  ...
                  ElevatedButton(
                    ...
                    child: SizedBox(
                      ...
                      child: Center(
                        child: Text(tn.keepWatching ?? 'Lanjut Nonton', textAlign: TextAlign.center),
                      ),
                    ),
                  ),
                  fivePx,
