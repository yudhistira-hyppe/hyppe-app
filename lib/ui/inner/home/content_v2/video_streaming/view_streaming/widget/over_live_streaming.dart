        ...
        Positioned.fill(
          child: Container(
            ...
            decoration: BoxDecoration(
              image: isErrorImage ? const DecorationImage(image: AssetImage('${AssetPath.pngPath}profile-error.jpg'), fit: BoxFit.cover) : DecorationImage(
        ...
        Align(
          ...
          child: Column(
            ...
            children: [
              CustomTextWidget(
                textToDisplay:
                widget.notifier.language.liveStreamingIsOver ?? '',
              ...
              CustomTextWidget(
                textToDisplay:
                '${widget.notifier.totViewsEnd} ${widget.notifier.language.viewers}',
                textStyle: const TextStyle(
              ...
              SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: streamerImage(
                      displayPhotoProfileOriginal(widget.data
