          ...
          child: notifier.bankData == null
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      CustomTextWidget(
                          textToDisplay: notifier.language.paymentBefore!,
                      ...
                      Row(
                        ...
                        children: [
                          CustomTextWidget(
                            ...
                            textToDisplay:
                                DateFormat('EEEE, dd MMM yyyy HH:mm', 'en_US')
                          ...
                          CustomTextWidget(
                            ...
                            textStyle: textTheme.bodyLarge!.copyWith(
                                color: const Color.fromRGBO(201, 29, 29, 1)),
                          ),
                        ],
                      ),
                          ...
                          children: [
                            CustomTextWidget(
                                textToDisplay: notifier
                                    .paymentMethodNotifier.postResponse!.bank!,
                                textStyle: textTheme.bodyMedium),
                            Image(
                                width: 77 * SizeConfig.scaleDiagonal,
                                image:
                                    NetworkImage(notifier.bankData!.bankIcon!))
                          ],
                        ),
                      ),
                      Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(notifier
                                  .paymentMethodNotifier.postResponse!.nova!),
                              GestureDetector(
                                onTap: () {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                          content: Text(notifier
                                              .language.vaCopyToClipboard!)));
                                },
                                child: Container(
                                  padding: const EdgeInsets.symmetric(
                                  ...
                                  child: CustomTextWidget(
                                      textToDisplay: notifier.language.copy!,
