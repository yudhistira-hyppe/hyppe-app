    ...
    return Consumer<AccountPreferencesNotifier>(
      builder: (_, notifier, __) => Padding(
        ...
        child: CustomTextFormField(
            ...
            textInputType:
                keyboardNewline ? TextInputType.multiline : TextInputType.text,
            ...
            inputDecoration: InputDecoration(
              ...
              enabledBorder: UnderlineInputBorder(
                  borderSide: BorderSide(
                      color: controller == null || controller!.text.isEmpty
                          ? Theme.of(context).iconTheme.color!
                          : kHyppePrimary,
                      width: 1)),
              focusedBorder: const UnderlineInputBorder(
                  borderSide: BorderSide(color: Color(0xff822E6E), width: 1)),
              contentPadding: const EdgeInsets.only(bottom: 2),
              floatingLabelBehavior: FloatingLabelBehavior.always,
            ),
            inputAreaWidth: SizeConfig.screenWidth!,
            inputAreaHeight: inputAreaHeight == null
                ? 50 * SizeConfig.scaleDiagonal
                : inputAreaHeight!,
            maxLength: maxLength,
            maxLines: 20,
            minLines: 1,
            textInputAction: keyboardNewline
