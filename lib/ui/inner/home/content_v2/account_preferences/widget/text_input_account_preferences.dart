        ...
        builder: (_, notifier, __) => Padding(
          ...
          child: CustomTextFormField(
              ...
              inputDecoration: InputDecoration(
                ...
                enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: controller == null || controller!.text.isEmpty ? Theme.of(context).iconTheme.color ?? Colors.white : kHyppePrimary, width: 0.2)),
