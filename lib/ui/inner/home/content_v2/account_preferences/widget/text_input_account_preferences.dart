...
class TextInputAccountPreferences extends StatelessWidget {
  ...
  const TextInputAccountPreferences(
      {this.onTap, this.hintText, this.labelText, this.readOnly = false, this.controller, this.inputFormatter});
  @override
      ...
      builder: (_, notifier, __) => Padding(
        ...
        child: CustomTextFormField(
          ...
          inputDecoration: InputDecoration(
            ...
            enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: controller == null || controller!.text.isEmpty
                ? Theme.of(context).iconTheme.color!
                : kHyppePrimary, width: 1)),
            focusedBorder: const UnderlineInputBorder(borderSide: BorderSide(color: Color(0xff822E6E), width: 1)),
