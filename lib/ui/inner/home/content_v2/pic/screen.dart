  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    switch (state) {
      ...
      case AppLifecycleState.resumed:
        print("========= resumed pict  $isactivealiplayer - $isActivePage - ${context.read<PreviewVidNotifier>().canPlayOpenApps && !SharedPreference().readStorage(SpKeys.isShowPopAds) && isActivePage}");
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SharedPreference().readStorage(SpKeys.statusVerificationId) == VERIFIED && (picData?.boosted.isEmpty ?? [].isEmpty) && (picData?.reportedStatus != 'OWNED' && picData?.reportedStatus != 'BLURRED' && picData?.reportedStatus2 != 'BLURRED') && picData?.email == email
                                      ? Container(
