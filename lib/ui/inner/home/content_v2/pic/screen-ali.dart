...
class _HyppePreviewPicAliState extends State<HyppePreviewPicAli>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      // initAlipayer();
      print(
          "===============init ali player ${fAliplayer?.playerId} ===========");
  ...
  _initListener(PreviewPicNotifier notifier) {
    ...
    fAliplayer?.setOnError((errorCode, errorExtra, errorMsg, playerId) {
      print(
          "============init ali player error $errorCode - $errorExtra - $errorMsg - $playerId");
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    if (info.visibleFraction == 1 ||
                                      ...
                                      if (_lastCurPostId != _curPostId) {
                                        ...
                                        Future.delayed(
                                            const Duration(milliseconds: 100),
                                            () {
                                          if (mn?.tutorialData.isNotEmpty ??
                                              [].isEmpty) {
                                            indexKeySell = mn?.tutorialData
                                                    .indexWhere((element) =>
                                                        element.key ==
                                                        'sell') ??
                                                0;
                                            indexKeyProtection = mn
                                                    ?.tutorialData
                                                    .indexWhere((element) =>
                                                        element.key ==
                                                        'protection') ??
                                            ...
                                            if ((picData?.saleAmount ?? 0) >
                                                0) {
                                              if (mn?.tutorialData[indexKeySell]
                                                          .status ==
                                                      false &&
                                                  !globalChallengePopUp) {
                                                ShowCaseWidget.of(context)
                                                    .startShowCase([
                                                  picData?.keyGlobalSell ??
                                                      GlobalKey()
                                                ]);
                                              }
                                            }
                                            if (((picData?.certified ??
                                                    false) &&
                                ...
                                if (picData?.email == email &&
                                    ...
                                    (picData?.boosted.isNotEmpty ?? [].isEmpty))
                                  Container(
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  if (_currentPlayerState ==
                      FlutterAvpdef.AVPStatus_AVPStatusStarted) {
                    fAliplayer?.play();
                  }
