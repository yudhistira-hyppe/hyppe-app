        ...
        child: Consumer2<PreviewPicNotifier, HomeNotifier>(builder: (_, notifier, home, __) {
          ...
          return PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return imagePic(picData: notifier.pic![index], index: index, notifier: notifier, homeNotifier: home);
              });
        }),
      ),
    );
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      if (data.location != '')
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: (data.tagPeople?.isNotEmpty ?? false) ? 12.0 : 0.0, vertical: 16.0),
                          child: Align(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Text(
                                    '${data.location}',
                                    maxLines: 1,
                                    style: const TextStyle(color: kHyppeLightBackground, fontSize: 10),
                ...
                Container(
                  ...
                  child: CustomDescContent(
                    ...
                    normStyle: const TextStyle(fontSize: 12, color: kHyppeTextPrimary),
                    hrefStyle: Theme.of(context).textTheme.subtitle2?.copyWith(color: kHyppePrimary),
                    expandStyle: Theme.of(context).textTheme.subtitle2?.copyWith(color: kHyppeTextPrimary),
                  ),
                ),
                if (data.music != null)
                  Container(
      ...
      child: Row(
        children: [
          Visibility(
            ...
            child: Container(
              padding: EdgeInsets.all(data.email == SharedPreference().readStorage(SpKeys.email) ? 2.0 : 13),
