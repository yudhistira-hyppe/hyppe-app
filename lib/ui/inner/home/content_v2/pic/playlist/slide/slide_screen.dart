    ...
    return ChangeNotifierProvider<SlidedPicDetailNotifier>(
      ...
      child: WillPopScope(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            body: Consumer<SlidedPicDetailNotifier>(
              builder: (context, value, child) {
                return _notifier.listData != null ? PageView.builder(
                    ...
                    return Stack(
                      children: [
                        ...
                        CustomBackgroundLayer(
                          ...
                          thumbnail: _notifier.listData![indexRoot].isApsara ?? false
                              ? _notifier.listData![indexRoot].mediaThumbUri
                              : _notifier.listData![indexRoot].fullThumbPath,
                        ),
                        // Content
                        InteractiveViewer(
                          ...
                          child: InkWell(
                            onDoubleTap: () {
                              context
                                  .read<LikeNotifier>()
                                  .likePost(context, _notifier.listData![indexRoot]);
                            },
                            child: CustomCacheImage(
                              // imageUrl: picData.content[arguments].contentUrl,
                              imageUrl: _notifier.listData![indexRoot].isApsara!
                                  ? _notifier.listData![indexRoot].mediaThumbUri
                                  : _notifier.listData![indexRoot].fullThumbPath,
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    ProfileComponent(
                                      ...
                                      onTapOnProfileImage: () => System()
                                          .navigateToProfile(
                                          context, _notifier.listData![indexRoot].email!),
                                      ...
                                      imageUrl:
                                      '${System().showUserPicture(_notifier.listData![indexRoot].avatar?.mediaEndpoint)}',
                                      createdAt: '${System().readTimestamp(
                                        DateTime.parse(_notifier.listData![indexRoot].createdAt!)
                                ...
                                _notifier.listData![indexRoot].email ==
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  Consumer<LikeNotifier>(
                                    builder: (context, notifier, child) => _buildButtonV2(
                                      context: context,
                                      colorIcon:
                                      (_notifier.listData![indexRoot].insight?.isPostLiked ??
                                          false)
                                          ? kHyppePrimary
                                          : kHyppeLightButtonText,
                                      iconData:
                                      '${AssetPath.vectorPath}${(_notifier.listData![indexRoot].insight?.isPostLiked ?? false) ? 'liked.svg' : 'none-like.svg'}',
                                      function: () =>
                                          notifier.likePost(context, _notifier.listData![indexRoot]),
                                    ),
                                  ),
                                  _buildButtonV2(
                                    context: context,
                                    ...
                                    function: _notifier.listData![indexRoot] != null
                                        ...
                                        data: _notifier.listData![indexRoot])
                                        : () {},
                                  ),
                                  if (_notifier.listData![indexRoot].saleAmount! > 0)
                                    _buildButtonV2(
                                      context: context,
                              ...
                              _notifier.listData![indexRoot].tagPeople!.length != 0 ||
                                  _notifier.listData![indexRoot].location != ''
                                  ? Padding(
                                ...
                                child: Row(
                                  children: [
                                    _notifier.listData![indexRoot].tagPeople!.length != 0
                                      ...
                                      icon: 'user',
                                      label:
                                      '${_notifier.listData![indexRoot].tagPeople!.length} people',
                                      function: () {
                                        context
                                            .read<PicDetailNotifier>()
                                            .showUserTag(
                                            context,
                                            _notifier.listData![indexRoot].tagPeople,
                                            _notifier.listData![indexRoot].postID);
                                      },
                                      width: 18,
                                    )
                                        : const SizedBox(),
                                    _notifier.listData![indexRoot].location == '' ||
                                        _notifier.listData![indexRoot].location == null
                                        ? const SizedBox()
                                        : PicTagLabel(
                                      icon: 'maptag-white',
