            ...
            children: [
              Positioned.fill(
                child: Builder(builder: (context) {
                  final language =
                      context.read<TranslateNotifierV2>().translate;
                  return Container(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomTextWidget(
                                          textToDisplay: language.sponsored ??
                                              'Bersponsor',
                                          textStyle: context
                                              .getTextTheme()
                                              .bodyMedium
                                      ...
                                      onTap: () async {
                                        ...
                                        if (secondsSkip < 1) {
                                          if (data.adsUrlLink?.isEmail() ??
                                            ...
                                            print(
                                                'second close ads: $secondsImage');
                                            System()
                                                .adsView(
                                                    widget.data, secondsImage,
                                                    isClick: true)
                                                .whenComplete(() {
