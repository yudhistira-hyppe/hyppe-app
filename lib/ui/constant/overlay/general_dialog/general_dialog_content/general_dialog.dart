...
class _GeneralAlertDialogState extends State<GeneralAlertDialog> {
  ...
  Widget _buildButton(
    ...
    //   child: CustomTextWidget(textToDisplay: caption, textStyle: theme.textTheme.labelLarge?.copyWith(color: textColor, fontSize: 10)),
    //   width: 120,
    //   height: 42,
    //   function: () {
    //     try {
