...
class OnStreamingOptions extends StatefulWidget {
  const OnStreamingOptions({super.key});
          ...
          CustomGesture(
              ...
              child: Container(
                ...
                child: CustomTextWidget(
                  textToDisplay:
                      language.disableComments ?? 'Nonaktifkan Komentar',
          ...
          CustomGesture(
            onTap: () async {
              await ShowGeneralDialog.generalDialog(
                  ...
                  bodyText: language.pauseLiveBody ??
                      "Your LIVE video will temporarily freeze when paused. You can pause for up to 5 minutes, 3 times.",
                  maxLineTitle: 1,
                  maxLineBody: 4,
