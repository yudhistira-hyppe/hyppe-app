...
class OnShowEffect extends StatelessWidget {
  ...
  Widget renderEffect(
    ...
    var filePath =
        '${notifier.effectPath}${Platform.pathSeparator}${effect.fileAssetName}';
    return InkWell(
      onTap: () {
      ...
      child: Container(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: notifier.selectedEffect == effect
                ? Border.all(color: kHyppePrimary, width: 2)
              ...
              Flexible(
                child: Stack(
                  children: [
                    ...
                    if (notifier.selectedEffect == effect && notifier.isDownloadingEffect)
                      const CustomLoading()
                  ],
                ),
              ),
